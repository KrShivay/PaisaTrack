...
class _TransactionsScreenState extends ConsumerState<TransactionsScreen> {
  ...
  List<TransactionListItem> _filterItems(List<TransactionListItem> items) {
    // ⚡ Bolt: Cached query outside the filter loop to avoid allocating memory for `.toLowerCase()` per item.
    ...
    return items.where((item) {
      ...
      if (q != null) {
        // ⚡ Bolt: Using early returns skips unnecessary `.toLowerCase()` evaluations if an earlier property matched.
