  ...
  List<TransactionListItem> _filterItems(List<TransactionListItem> items) {
    return items.where((item) {
      ...
      if (_query.isNotEmpty) {
        ...
        // ⚡ Bolt Optimization: Use short-circuit evaluation for search string matching
        // to avoid upfront string allocations for all fields if an early match is found.
