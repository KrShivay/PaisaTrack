...
| Bank parsing | HDFC, ICICI, SBI, Axis, Central Bank, Kotak, IndusInd, Paytm and generic coverage exist; sanitized salary-credit templates and sender-agnostic fallback are proven end to end; developer diagnostics expose content-free native live/batch filter and unknown-sender counters | Counters reset with the app process; real-bank breadth still requires sanitized evidence and exact parser assertions |
